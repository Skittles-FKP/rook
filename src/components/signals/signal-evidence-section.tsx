          ...
          {packet.items.map((item) => {
            ...
            return (
              <Link
                ...
                className="focus-ring grid gap-2 rounded-lg border border-white/10 bg-white/[0.035] p-3 transition hover:border-rook-cyan/35 sm:grid-cols-[auto_1fr_auto]"
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs leading-5 text-rook-muted">{item.summary}</p>
                </div>
